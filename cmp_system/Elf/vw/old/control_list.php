<?php 
	$view_update_link = "Task/ControlList/$id_project";
?>
<div>
	<div class="add">
		<a onclick="addFormJSON('task-modal-form');"><i class="glyphicon glyphicon-plus-sign"></i><?php echo $_['0'];?></a>
		<!--<a onclick = "exec('Task/InsertControl/<?php echo $id_user;?>','<?php echo $view_update_link; ?>');" style="cursor:pointer" <?php //data-toggle="modal" data-target="#addProject" ?>><i class="glyphicon glyphicon-plus-sign"></i>Добавить задачу</a> -->

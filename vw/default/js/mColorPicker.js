...
(function($){
  ...
  $.fn.mColorPicker.defaults = {
    ...
    changeColor: false,
    color: false,
    imageFolder: jsData.baseUrl+'lib/images/',
    swatches: [
      "#ffffff",
      "#ffff00",
      "#00ff00",
  ...
  $.fn.mColorPicker.events = function() {
    ...
    $('.mColorPickerTrigger').live('mousedown', $.fn.mColorPicker.colorShow);
  ...
  $.fn.mSetInputColor = function (color) {
	...
	$('#mColorPickerInput').css('background-color', color);
    $t.val(color).css(css).trigger('livechange');
